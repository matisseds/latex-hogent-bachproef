...
De scenario’s omvatten onder meer een sales-to-cash flow, een reparatieflow, een gecombineerde onderhouds- en onderdelenfactuur en een Peppol-readinesscontrole. Op die manier wordt nagegaan of de ontworpen TO-BE processen functioneel uitvoerbaar zijn binnen een gecontroleerde Odoo-omgeving.
...
De evaluatie focust op het aantal manuele stappen, de doorlooptijd per proces, de mate van traceerbaarheid, het aantal correctiemomenten en de voorbereiding op Peppol-compliance. Omdat historische logdata in de oorspronkelijke situatie beperkt beschikbaar is, worden AS-IS-inschattingen gecombineerd met observaties uit de shadowing en scenario-gebaseerde metingen binnen de PoC-omgeving.
...
\begin{itemize}
    \item \textbf{Afbakening van modules.} De Proof of Concept vertrekt vanuit standaard Odoo-functionaliteiten en gebruikt de modules Contacts, Sales, Invoicing, Inventory, Purchase en Repair.
    \item \textbf{Representatieve stamdata.} De testomgeving wordt opgebouwd met representatieve klant-, leveranciers-, product- en onderdelengegevens, aangevuld met btw-instellingen en voorbeeldfacturen.
    \item \textbf{Vaste testscenario’s.} De scenario’s omvatten een verkoopflow van offerte tot factuur, voorraadmutaties, service- en reparatieprocessen en een Peppol-readinesscontrole.
